/*
 * ARQUIVO: lib/src/features/example/data/models/example_model.freezed.dart
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExampleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
...
class _ExampleModel extends ExampleModel {
  const _ExampleModel({required this.id, required this.name}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExampleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name));
}
